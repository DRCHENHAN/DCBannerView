...
class DCBannerView: UIView {
    ...
    /// 显示数据
    private var _dataSource:    [DCBannerViewData]?
    ...
    /// 过度，避免数据为空
    private var imagesData: [DCBannerViewData] {
        set {
...
extension DCBannerView: UIScrollViewDelegate{
